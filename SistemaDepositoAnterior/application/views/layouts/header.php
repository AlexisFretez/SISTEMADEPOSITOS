...
<head>
    ...
    <title>Sistema de Gestion Depositos | Dashboard</title>
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?php echo base_url(); ?>" class="logo">
                ...
                <span class="logo-lg"><b>Gestion Depositos</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url() ?>assets/template/dist/img/avatar04.png" class="user-image" alt="User Image">
                                <span class="hidden-xs"><?php echo $this->session->userdata("nombre") ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <img src="<?php echo base_url() ?>assets/template/dist/img/avatar04.png" class="img-circle" alt="User Image" text-align="center">
                                    <p>
                                        <span text-align="center" class="hidden-xs"><?php echo $this->session->userdata("nombre") ?></span>
                                    </p>
                                    <p><small>Sistema de Gestion Depositos</small></p>
                                    <br>
