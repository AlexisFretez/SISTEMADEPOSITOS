...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <input type="hidden" id="modulo" value="presentacion">
                <div class="row">
                    <div class="col-md-12">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <?php if ($permisos->update == 1) : ?>
                                                            <a href="<?php echo base_url() ?>mantenimiento/presentacion/edit/<?php echo $presentacion->id; ?>" class="btn btn-warning"><span class="fa fa-pencil"></span></a>
                                                        <?php endif; ?>
                                                        <?php if ($permisos->delete == 1) : ?>
                                                            <a href="<?php echo base_url(); ?>mantenimiento/presentacion/delete/<?php echo $presentacion->id; ?>" class="btn btn-danger btn-remove"><span class="fa fa-remove"></span></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </td>
                                            </tr>
