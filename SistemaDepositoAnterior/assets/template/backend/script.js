        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                $.each(resp,function(key, value){
                    ...
                    html += "<td><button type='button' class='btn <btn-success></btn-success> btn-flat btn-selected' value='"+data+"'><span class='fa fa-check'></span></button></td>";
                    html += "</tr>";
                });
...
*/
    ...
    $("#searchProductoCompra").autocomplete({
        ...
        select:function(event, ui){
            ...
            html +="<td><input type='hidden' name='precios[]' value='"+ui.item.precio_compra+"'></td>";
            html +="<td><input type='text' name='cantidades[]' class='cantidadesCompra' value='1'></td>";
            html +="<td><input type='hidden' name='importes[]' value='"+ui.item.precio_compra+"'></td>";
            html +="<td><button type='button' class='btn btn-danger btn-remove-producto-compra'><span class='fa fa-times'></span></button></td>";
            html +="</tr>"
    ...
    $("#searchProductoCompra bk").autocomplete({
        source:function(request, response){
            $.ajax({
                url: base_url+"movimientos/compras/getProductos",
                type: "POST",
