...
INSERT INTO `almacen` (`id`, `nombre`, `fecha_creacion`, `estado`, `descripcion`, `predeterminado`, `precio`) VALUES
	(10, 'Deposito 1', '2020-08-02 00:00:00', 0, NULL, NULL, NULL),
	(11, 'Deposito 2', '2020-08-02 00:00:00', 0, NULL, NULL, NULL),
	(12, 'Deposito 3', '2020-08-02 00:00:00', 0, NULL, NULL, NULL),
	(13, 'Deposito 4', '2020-08-02 00:00:00', 0, NULL, NULL, NULL),
	(14, 'Deposito 5', '2020-08-02 00:00:00', 0, NULL, NULL, NULL),
	(15, 'Deposito1gfdgt', '2020-09-03 00:00:00', 1, ' poet 300', NULL, '10.00'),
	(16, 'Deposito 13333', '2020-09-03 00:00:00', 1, ' poet 300', NULL, '20000'),
	(17, 'Deposito 15fgfg', '2020-09-03 04:58:00', 1, 'Desinfectante Poet Primavera de 648ml', NULL, '10.00');
...
-- Volcando datos para la tabla compras_ventas.categorias: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla compras_ventas.compras: ~21 rows (aproximadamente)
DELETE FROM `compras`;
...
INSERT INTO `compras` (`id`, `fecha`, `subtotal`, `total`, `comprobante`, `proveedor_id`, `tipo_pago_id`, `usuario_id`, `almacen_id`, `estado`, `numero`, `serie`) VALUES
	(16, '2020-08-02 00:00:00', '50000.00', '50000.00', '01', 1, 1, 5, 10, 1, '01', '01'),
	(17, '2020-08-02 00:00:00', '5000.00', '5000.00', '011', 1, 1, 5, 10, 1, '65563', '10'),
	(18, '2020-08-02 00:00:00', '1000.00', '1000.00', '010', 1, 2, 5, 11, 1, '888', '01'),
	(19, '2020-08-02 00:00:00', '900.00', '900.00', '011', 1, 1, 5, 12, 1, '555', '21'),
	(20, '2020-08-03 00:00:00', '25.00', '25.00', '01', 1, 1, 8, 10, 1, '222', '333'),
	(21, '2020-08-03 00:00:00', '1000.00', '1000.00', '01', 1, 1, 8, 10, 1, '02', '01'),
	(22, '2020-09-03 00:00:00', NULL, NULL, '454', 2, NULL, 8, 15, 1, '112', '54488'),
	(23, '2020-09-03 00:00:00', NULL, NULL, 'csasds', 2, NULL, 8, 16, 1, '13133', '122'),
	(24, '2020-09-03 00:00:00', NULL, NULL, 'KSDKASAKS', 2, NULL, 8, 15, 1, '112', '54488'),
	(25, '2020-09-03 00:00:00', NULL, NULL, 'alxxisdsdi', 1, NULL, 8, 10, 1, '108108', '54488'),
	(26, '2020-09-03 10:19:00', NULL, NULL, 'KSDKASAKS', 1, NULL, 8, 10, 1, '108', '54488'),
	(27, '2020-09-03 10:25:00', NULL, NULL, '454', 2, NULL, 8, 10, 1, '108108', '54488'),
	(28, '2020-09-03 10:29:00', NULL, NULL, 'KSDKASAKS', 1, NULL, 8, 15, 1, '112', '54488'),
	(29, '2020-09-03 10:30:00', NULL, NULL, '888', 1, NULL, 8, 16, 1, '108108', '54488'),
	(30, '2020-09-03 10:33:00', NULL, NULL, 'oikomina', 1, NULL, 8, 11, 1, '108', '100'),
	(31, '2020-09-03 10:36:00', NULL, NULL, '454', 1, NULL, 8, 17, 1, '108108', '54488'),
	(32, '2020-09-03 10:39:00', NULL, NULL, '108', 1, NULL, 8, 13, 1, '108', '100'),
	(33, '2020-09-03 10:42:00', NULL, NULL, '108', 1, NULL, 8, 11, 1, '108108', '54488'),
	(34, '2020-09-03 10:43:00', NULL, NULL, 'KSDKASAKS', 2, NULL, 8, 13, 1, '108', '54488'),
	(35, '2020-09-03 10:54:00', NULL, NULL, 'tembo', 2, NULL, 8, 10, 1, '56356', '235353'),
	(36, '2020-09-03 10:58:00', NULL, NULL, '454', 2, NULL, 8, 15, 1, '108', '54488');
...
-- Volcando datos para la tabla compras_ventas.detalle_compra: ~6 rows (aproximadamente)
...
INSERT INTO `inventarios` (`id`, `month`, `year`, `usuario_id`, `created_at`) VALUES
	...
	(21, 6, '2020', 1, '2020-06-24 20:00:00');
...
-- Volcando datos para la tabla compras_ventas.logs: ~211 rows (aproximadamente)
DELETE FROM `logs`;
...
INSERT INTO `logs` (`id`, `fecha`, `usuario_id`, `modulo`, `accion`) VALUES
	...
	(196, '2020-08-18 18:38:48', 5, 'Usuarios', 'Inicio de sesión'),
	(197, '2020-08-18 18:38:57', 5, 'Usuarios', 'Cierre de sesión'),
	(198, '2020-08-18 18:39:06', 8, 'Usuarios', 'Inicio de sesión'),
	(199, '2020-08-19 17:16:58', 5, 'Usuarios', 'Inicio de sesión'),
	(200, '2020-08-20 18:56:09', 5, 'Usuarios', 'Cierre de sesión'),
	(201, '2020-08-20 18:56:15', 8, 'Usuarios', 'Inicio de sesión'),
	(202, '2020-09-03 04:37:09', 8, 'Usuarios', 'Inicio de sesión'),
	(203, '2020-09-03 04:53:29', 8, 'Usuarios', 'Inicio de sesión'),
	(204, '2020-09-03 09:48:44', 8, 'Usuarios', 'Inicio de sesión'),
	(205, '2020-09-03 10:33:19', 8, NULL, 'Inserción de una nueva venta con identificador 0'),
	(206, '2020-09-03 10:36:48', 8, NULL, 'Inserción de una nueva venta con identificador 31'),
	(207, '2020-09-03 10:39:46', 8, NULL, 'Inserción de una nueva venta con identificador 32'),
	(208, '2020-09-03 10:42:25', 8, NULL, 'Inserción de una nueva venta con identificador 0'),
	(209, '2020-09-03 10:43:52', 8, NULL, 'Inserción de una nueva venta con identificador 0'),
	(210, '2020-09-03 10:55:58', 8, NULL, 'Inserción de una nueva venta con identificador 0'),
	(211, '2020-09-03 10:58:33', 8, NULL, 'Inserción de una nueva venta con identificador 36');
...
INSERT INTO `menus` (`id`, `nombre`, `link`, `parent`, `orden`, `estado`) VALUES
	...
	(32, 'Empresas', 'mantenimiento/proveedor', '9', 0, 1),
...
-- Volcando datos para la tabla compras_ventas.productos: ~7 rows (aproximadamente)
...
INSERT INTO `productos` (`id`, `codigo_barras`, `codigo`, `codigo_slug`, `nombre`, `descripcion`, `precio`, `precio_compra`, `stock`, `stock_minimo`, `categoria_id`, `subcategoria_id`, `subcategoria`, `imagen`, `presentacion_id`, `marca_id`, `pasillo`, `estanteria`, `condicion`, `asociado`, `estado`, `almacen_id`) VALUES
	(188, '7756641003971', NULL, NULL, 'Desinfectante Poet Primavera de 648ml', 'Desinfectante Poet Primavera de 648ml', '3.00', '2.50', 35, 10, 25, 5, 0, 'Poet_Portada.jpg', 1, 1, '3', '4', NULL, NULL, 1, NULL),
	...
	(192, '1002255555', NULL, NULL, 'CLAVOS', 'para alabar ropa', '150', '100', 20, 50, 25, 5, 0, 'fhfhf.png', 1, 1, '1', '5', NULL, NULL, 0, NULL),
	(193, '108108', NULL, NULL, 'Avena 31 ositos', 'vx', '15000', '5000', 160, 20, 25, 6, 0, 'REST.jpg', 1, 1, '1', '5', NULL, NULL, 0, NULL),
...
-- Volcando datos para la tabla compras_ventas.proveedor: ~2 rows (aproximadamente)
...
INSERT INTO `proveedor` (`id`, `nombre`, `nit`, `contribuyente_id`, `direccion`, `telefono`, `email`, `contacto`, `tel_contacto`, `banco`, `no_cuenta`, `estado`) VALUES
	(1, 'JJ Moran S.A', '10477471123', 3, 'Calle Arica 430', '988898989', 'jjmoran@ventas.pe', 'Jose Campos', '989112121', NULL, NULL, 1),
	(2, 'ALEXIS', '4555', 3, 'itaufgua', '888', 'aada@gmai.com1', '444', '55888', NULL, NULL, 1);
